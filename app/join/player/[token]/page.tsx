 ...
 * Player join page.
 *
 * URL: /join/player/[token]?t=[tournamentId]
 *
 * Requirements: 5.1, 5.2, 5.3, 5.4, 5.5, 5.6, 19.2
 */
export default function PlayerJoinPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch(`/api/tournaments/${tournamentId}/join/player`, {
        method: 'POST',
      ...
      if (res.ok) {
        router.push(`/t/${tournamentId}/player`);
        return;
      }
